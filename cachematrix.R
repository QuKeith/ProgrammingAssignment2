## The following pair of functions allows for the computation of the inverse of a matrix...
    ##...and make the computation more efficient with the use of cached data.
